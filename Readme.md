...
```
 ...
 setOptions:               // Запрос на установку настроек пользователя
     ...
     params:               // Параметры запроса из гейта
         ...
         notify <Object>   // Объект настроек онлайн уведомлений, на данный момент не стандартизирован
         push <Object>     // Объект настроек push-нотификаций, на данный момент не стандартизирован
         mail <Object>     // Объект настроек писем (не реализовано)
